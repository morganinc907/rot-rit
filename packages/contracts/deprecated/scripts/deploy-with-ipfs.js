...
async function main() {
  ...
  Contracts.Raccoons = await raccoons.getAddress();
  console.log("✅ Raccoons deployed at:", Contracts.Raccoons);
  
  // Configure Raccoons IPFS URIs
  await (await raccoons.setBaseTokenURI(`ipfs://${METADATA_HASH}/`, {gasLimit: 100000})).wait();
  await (await raccoons.setRevealed(true, {gasLimit: 50000})).wait();
  console.log("✅ Raccoons IPFS URIs configured and revealed");
