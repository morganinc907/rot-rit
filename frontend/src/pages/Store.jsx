...
export default function Store() {
  ...
  const { keyPrice, keyBalance, buyKeys, isLoading, contracts } = useKeyShop();
  ...
  useEffect(() => {
    const fetchCosmetics = async () => {
      ...
      try {
        ...
        for (let i = 0; i < availableIds.length; i++) {
          ...
          try {
            ...
            cosmeticsData.push({
              ...
              active: typeData[6],
              dropRate, // Add drop rate from MAW pool
        ...
        setCurrentMonthlySet({ name: 'Fragment Sacrifice Catalog', id: 1 });
      } catch (error) {
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="text-right">
              ...
              <p className="text-gray-400 text-sm">
                Sacrifice fragments at the Maw
              </p>
            </div>
          </div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-400 mb-4">
                  Available from the Maw by sacrificing Lantern Fragments
                </p>
